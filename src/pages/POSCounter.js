...
const POSCounter = () => {
    ...
    const addToCart = () => {
        ...
        const cartItem = {
            ...
            product_price: selectedProduct.original_price || selectedProduct.price, // Gunakan harga normal
            quantity,
            modifiers,
    ...
    return (
        <AdminLayout>
            <div className="max-w-7xl mx-auto">
                <h1 className="text-3xl font-bold text-gray-900 mb-6">🛒 POS Kasir</h1>
